...
import { DEFAULTS, loadConfig, readEnvConfig, resolveCompactAfterTokens, type Config } from "../src/config.js";
...
describe("V3 config", () => {
	...
	describe("resolveCompactAfterTokens", () => {
		it("returns the calibrated value in calibrated mode", () => {
			const config: Config = { ...DEFAULTS, compactAfterTokensMode: "calibrated", compactAfterTokens: 81000 };
		...
		it("scales by context window in ratio mode", () => {
			const config: Config = { ...DEFAULTS, compactAfterTokensMode: "ratio", compactAfterTokensRatio: 0.5, compactAfterTokens: 81000 };
