...
export interface CronJob {
  ...
  notify?: boolean;
  /** Subagent jobs only. If true, loads all registered extensions. If array of package names, only those extensions. Default undefined (none). */
  extensions?: boolean | string[];
  /** Subagent jobs only. If true, loads all skills. If array of skill names, only those skills. Default undefined (none). */
