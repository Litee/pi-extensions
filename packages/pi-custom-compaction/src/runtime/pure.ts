...
export function resolveEffectivePolicy(
	...
	const profileTemplates = profile?.override.template !== undefined || profile?.override.updateTemplate !== undefined
		? {
				...(profile.override.template !== undefined ? { template: profile.override.template } : {}),
				...(profile.override.updateTemplate !== undefined ? { updateTemplate: profile.override.updateTemplate } : {}),
		  }
		: undefined;
	return {
		policy,
		...
		sessionModel,
		...(profileTemplates !== undefined ? { profileTemplates } : {}),
	};
}
