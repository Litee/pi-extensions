 ...
 * pi-btw
 *
 * Upstream source: https://github.com/dbachelder/pi-btw
 * Copied from dbachelder/pi-btw @ v0.4.0 (extensions/btw.ts).
 *
 ...
 *
 * Original author: Dan Bachelder. MIT licensed — see packages/pi-btw/LICENSE.
 *
 * This copy lives in pi-extensions/packages/pi-btw for local experimentation;
 * any upstream fixes should be pulled through via a diff against the link
 * above.
 */
...
export default function (pi: ExtensionAPI) {
  ...
  async function resolveBtwSettings(
    ...
    return {
      ...
      ...(resolvedModel.fallbackReason !== undefined ? { fallbackReason: resolvedModel.fallbackReason } : {}),
    };
  }
