 ...
 * - If no changes and no new commits: remove worktree entirely.
 * - If changes exist or agent made commits: create a branch, commit any
 *   uncommitted changes, return branch info.
 */
